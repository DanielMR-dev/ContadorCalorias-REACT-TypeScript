...
export default function Form({dispatch, state} : FormProps) {
    ...
    useEffect(() => {
        if(state.activeId) {
            const selectedActivity = state.activities.filter(stateActivity => stateActivity.id === state.activeId)[0] // Filtro por el id que el usuario presionó en pantalla y lo agrego en una nueva variable
